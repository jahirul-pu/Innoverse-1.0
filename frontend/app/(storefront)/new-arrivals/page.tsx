  ...
  useEffect(() => {
    async function loadFilterMetadata() {
      try {
        ...
        console.error("Failed to load new arrivals filter metadata", err);
      }
    }
    loadFilterMetadata();
  }, []);
  ...
  useEffect(() => {
    async function loadNewArrivals() {
      try {
        ...
        console.error("Failed to fetch new arrivals products list", err);
      } finally {
        setLoading(false);
      }
    }
        ...
        <div className={styles["listing-grid"]}>
          {loading ? (
            ...
            <div className={styles["listing-empty"]}>
              ...
              <h3 className={styles["listing-empty__title"]}>No new products found</h3>
              <p className={styles["listing-empty__text"]}>We haven't cataloged any new arrivals recently. Stay tuned!</p>
